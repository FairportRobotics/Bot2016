...
import org.usfirst.frc.team578.robot.commands.autonomous.turns.AutonomousTurnTo125;
...
public class AutonomousRightRallyScoringRight extends CommandGroup {
	...
	public AutonomousRightRallyScoringRight() {
		...
		addSequential(new AutonomousDriveCommand(1, 1, 1.13));// forward 7.54
																// feet
		addSequential(new AutonomousTurnTo125(RobotMap.DEFAULT_LEFT_WHEEL_TURN_SPEED, RobotMap.DEFAULT_RIGHT_WHEEL_TURN_SPEED));// turn
		// left
		// 60
		// degrees
